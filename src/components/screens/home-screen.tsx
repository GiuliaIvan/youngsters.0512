    ...
    <div className="px-4">
      <AccentCard variant="purple" className="p-4">
        <div className="flex items-start gap-3">
          <div className="w-11 h-11 rounded-full bg-white overflow-hidden flex items-center justify-center flex-shrink-0 shadow-sm">
            <img 
              src="/Vippsi 1.png" 
              alt="Vippsi" 
              className="w-10 h-10 object-cover scale-150 translate-y-0.5"
            />
          </div>
